...
hypotheek_nieuw: {
    prompt: (bot) => bot.say(`Momenteel biedt Independer alleen voor Starters een hypotheek. Maar met deze link vindt je wel goede aanbieders %[Toon meer](http://wwww.nu.nl)`),
    receive: () => 'processing'
},
